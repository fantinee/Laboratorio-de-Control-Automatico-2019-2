...
cliente = Cliente("opc.tcp://127.0.0.1:4840/freeopcua/server/",
...
#x0=[28.029, 43.489, 10.091, 15.656] #Condición inicial de los tanques (eq para u_eq = (0.5,0.5)) y gamma = (0.4,0.4)
Hmax = 50
voltmax = 10
fps = 20
